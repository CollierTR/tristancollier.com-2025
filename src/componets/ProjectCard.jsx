...
const ProjectCard = ({img='https://placehold.co/600x400', title='Awsome Project', description=descriptionText, weblink, githubLink, youtubeLink, technologiesArr=techArr}) => {
    ...
    <div className="w-full bg-black  mx-auto border-2 border-primary rounded-2xl overflow-hidden p-2 pb-6">
        ...
        <div className="flex flex-col justify-center">
            <div className="flex justify-between place-items-center">
                <a href={weblink}><p className="text-3xl m-4 font-medium hover:text-primary-light cursor-pointer">{title}</p></a>
                <a href={weblink}><FontAwesomeIcon icon={faArrowUpRightFromSquare} className="m-4 text-2xl hover:text-primary-light cursor-pointer"/></a>
            </div>
            ...
            <div className="flex gap-4 mx-4">
                {weblink && <a href={weblink}><FontAwesomeIcon icon={faGlobe} className="text-2xl cursor-pointer hover:text-primary-light" /></a>}
                {githubLink && <a href={githubLink}><FontAwesomeIcon icon={faGithub} className="text-2xl cursor-pointer hover:text-primary-light" /></a>}
                {youtubeLink && <a href={youtubeLink}><FontAwesomeIcon icon={faYoutube} className="text-2xl text-red-700 cursor-pointer hover:text-primary-light"/></a>}
            </div>
        </div>
